...
namespace SWP391Web.Application.IServices
{
    public interface IPaymentService
    {
        ...
        Task<ResponseDTO> GetAllPaymentTransaction(ClaimsPrincipal userClaim, int pageNumber, int pageSize, DateOnly? from, DateOnly? to, TransactionStatus? status, CancellationToken ct);
    }
}
